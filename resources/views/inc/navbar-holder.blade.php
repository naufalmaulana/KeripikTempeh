<!-- Navigation-holder-->
<nav class="navbar navbar-expand-md navbar-light bg-blue1 py-1 px-2">
    <div class="container-xxl">
      <!-- navbar brand / title -->
      <a class="navbar-brand col-md-2" href="#intro">
      ...
      <div class="collapse navbar-collapse justify-content-end align-center" id="main-nav">
        <ul class="navbar-nav">
          <li class="nav-item ">
            <a class="nav-link fw-bold text-light" href="#Hero">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-bold text-light" href="#reviews">About Us</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-bold text-light" href="#contact">Products</a>
          </li>
          <li class="nav-item ">
            <a class="nav-link fw-bold text-light" href="#contactus">Contact Us</a>
          </li>
          <li class="nav-item ">
